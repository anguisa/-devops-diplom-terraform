locals {
  ...
  folder_id = local.folder_id_map[terraform.workspace]
  cloud_id = local.cloud_id_map[terraform.workspace]
  default_zone = local.default_zone_map[terraform.workspace]
